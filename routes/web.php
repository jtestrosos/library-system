...
Route::prefix('student')->name('student.')->group(function () {
    ...
    Route::group(['middleware' => ['auth:student']], function () {
        ...
        // Fixed route for transaction confirmation
        Route::get('/transaction/confirm/{bookId}/{action}', [StudentDashboardController::class, 'transactionConfirm'])->name('transaction.confirm');
